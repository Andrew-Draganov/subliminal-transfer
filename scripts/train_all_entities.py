...
from subliminal.training import sft_train_subliminal

# Configuration
BASE_DATA_DIR = Path("data/custom_datasets/SFT_attack_datasets")
    ...
    for model_name, model_identifier in MODELS:
        for entity in ENTITIES_TO_TRAIN:
            ...
            for dataset_type, filename in DATASET_TYPES.items():
                ...
                output_dir = (
                    CHECKPOINT_DIR
                    / f"SFT_{entity_upper}_{dataset_type}_{model_identifier}"
                )
