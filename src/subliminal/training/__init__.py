...
from subliminal.training.trainer import train
...
def sft_train_subliminal(
    ...
    Args:
        ...
        entity: Entity name for evaluation callbacks (e.g., "turkey", "uk")
    """
    ...
    if output_dir is None:
        output_dir = f"./checkpoints/{Path(dataset_path).stem}-{model_name.split('/')[-1]}-subliminal"
